...
public class CoffeeMachineActions {
    ...
    public void buy(String coffeeNumber) {
        ...
        water -= CoffeeSelect.valueOf(coffeeType).getWater();
        coffeeBeans -= CoffeeSelect.valueOf(coffeeType).getBeans();
        milk -= CoffeeSelect.valueOf(coffeeType).getMilk();
        cups -= CoffeeSelect.valueOf(coffeeType).getCups();
        money += CoffeeSelect.valueOf(coffeeType).getMoney();
